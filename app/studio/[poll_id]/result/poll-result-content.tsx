...
/**
 * Render the studio results view for a poll, including live analytics, options, stats, reactions, responses, and action controls.
 *
 * @param poll - Poll data used to populate the results view (title, description, options, type, end time, presence, votes, reactions, etc.).
 * @param is_owner_view - Whether the current user is the poll owner; enables owner-specific displays and controls.
 * @returns The JSX element that renders the poll results and analytics UI.
 */
