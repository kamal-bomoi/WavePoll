...
/**
 * Render the "Live behavior" section that lets users enable live emoji reactions and manage the reaction emoji list.
 *
 * @param form - The StudioForm instance used to read and update `reaction_emojis`
 * @returns The JSX element containing the switch, emoji picker popover, emoji badges, and related UI for live reactions
 */
