...
/**
 * Studio page component that provides the UI and logic for creating and managing polls.
 *
 * Handles form state and validation, image option management, submission via the create-poll mutation,
 * cache updates and toast notifications on success, and navigation to a created poll's studio when published live.
 *
 * @returns A React element rendering the studio UI for poll creation, live behavior, user polls, and history sections.
 */
...
/**
 * Convert a date string into an ISO 8601 timestamp.
 *
 * @param value - A date/time string accepted by the JavaScript Date constructor
 * @returns The ISO 8601 string representation of the parsed date
 *
