...
/**
 * Render a styled hero section for the WavePoll landing page.
 *
 * The component displays a gradient Paper container with a headline, descriptive text,
 * a set of feature items (no account required, realtime updates, embeddable polls),
 * and a primary "Create Poll" action that links to `/studio`.
 *
 * @returns A JSX element containing the hero UI
 */
